...
#include <stdlib.h>
#include <conio.h> 
// RTC timer procedures
// by wbc\\bz7 12.11.2o15

// some guidelines :)
// - timer can run at freqs from 1 to 8192 hz (look at rtc_timeRate and 
...
#define rtc_timerRate    8192
#define rtc_clockDivisor 3
